...
class GradCamPlusPlus:
    ...
    def get_gradcam_plus_plus(self, img_array):
        ...
        sum_grads = tf.tile(sum_grads,
                            [conv_outputs.shape[1], conv_outputs.shape[2], 1])  # Tile across height and width
    ...
    def evaluate_gradcam_on_test_set(self, test_images_and_masks, threshold=0.5):
        iou_scores = []
        dice_scores = []
        ...
        for img_path, ground_truth_path in test_images_and_masks:
            ...
            heatmap_resnet = self.get_gradcam_plus_plus(img_array)
